import json
from exceptions import LevelError, NameAccessError, IDAccessError
...
class User:
    ...
    def __hash__(self):
        return hash((self.name + str(self.u_id))) * self.lvl
...
if __name__ == '__main__':
    user_base = Terminal()
    login_user = user_base.login('SomeName', 1)
    user_base.login('SomeName', 1)
    new_user = User('NewName', '777', 2)
